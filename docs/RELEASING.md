...
4. Verify the intended version tag does not already exist. Create an annotated tag on the validated commit and push it. Never move an existing published tag to hide a fix.
