...
plugins {
    // Auto-provision JDK 21 for Robolectric/toolchain parity on clean runners.
...
include(":test-fixtures:locale-plugin-fixture")
include(":wear")