...
fun actionPresentation(type: ActionType): Triple<Int, Int, ImageVector> = when (type) {
    ...
    ActionType.SYSTEM_SET_TIMER -> Triple(R.string.action_timer, R.string.action_timer_sub, Icons.Filled.Timer)
    ...
    ActionType.SYSTEM_OPEN_DEVICE_STORE -> Triple(R.string.action_device_store, R.string.action_device_store_sub, Icons.Filled.Store)
    ...
    ActionType.SYSTEM_MEDIA_PLAY_FROM_SEARCH -> Triple(R.string.action_media_search, R.string.action_media_search_sub, Icons.Filled.MusicNote)
    ...
    ActionType.CALL_BLOCK -> Triple(R.string.action_call_block, R.string.action_call_block_sub, Icons.AutoMirrored.Filled.PhoneMissed)
    ...
    ActionType.SYSTEM_PRIVATE_DNS -> Triple(R.string.action_private_dns, R.string.action_private_dns_sub, Icons.Filled.Public)
    ...
    ActionType.SYSTEM_CHARGING_LIMIT -> Triple(R.string.action_charging_limit, R.string.action_charging_limit_sub, Icons.Filled.BatteryChargingFull)
    ActionType.SYSTEM_CHARGING_FEEDBACK -> Triple(R.string.action_charging_feedback, R.string.action_charging_feedback_sub, Icons.Filled.Vibration)
    ...
    ActionType.ROM_CUSTOM_SETTING -> Triple(R.string.action_rom_setting_set_setting, R.string.action_rom_setting_set_setting_sub, Icons.Filled.Tune)
    ActionType.ROM_QS_TILES -> Triple(R.string.action_rom_setting_qs_tiles, R.string.action_rom_setting_qs_tiles_sub, Icons.Filled.SettingsOverscan)
    ActionType.ROM_STATUS_BAR -> Triple(R.string.action_rom_setting_status_bar, R.string.action_rom_setting_status_bar_sub, Icons.Filled.BarChart)
    ActionType.ROM_LOCKSCREEN -> Triple(R.string.action_rom_setting_lockscreen, R.string.action_rom_setting_lockscreen_sub, Icons.Filled.Lock)
    ActionType.ROM_NAVIGATION -> Triple(R.string.action_rom_setting_navigation, R.string.action_rom_setting_navigation_sub, Icons.Filled.TouchApp)
    ActionType.ROM_THEME -> Triple(R.string.action_rom_setting_theme, R.string.action_rom_setting_theme_sub, Icons.Filled.Gradient)
    ActionType.ROM_AMBIENT_AOD -> Triple(R.string.action_rom_setting_ambient_aod, R.string.action_rom_setting_ambient_aod_sub, Icons.Filled.WbSunny)
    ActionType.ROM_NOTIFICATIONS -> Triple(R.string.action_rom_setting_notifications, R.string.action_rom_setting_notifications_sub, Icons.Filled.NotificationsActive)
    ...
    ActionType.ROM_BATCH -> Triple(R.string.action_rom_setting_batch, R.string.action_rom_setting_batch_sub, Icons.Filled.Build)
}
