    ...
    testOptions {
        unitTests {
            ...
            all {
                ...
                // Robolectric on JDK 21 needs reflective access to JDK internals;
                // without these flags SDK 37 sandboxes crash with
                // IllegalAccessException inside AndroidInterceptors.
                it.jvmArgs(
